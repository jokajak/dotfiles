...
//
// Per https://zmk.dev/docs/behaviors/hold-tap
...
UNICODE_MORPH_MODS
    ...
    world_currency_LALT: world_currency_LALT {
        compatible = "zmk,behavior-mod-morph";
        #binding-cells = <0>;
        bindings = D_RALT|MOD_LCTL|MOD_RCTL|MOD_RSFT)>;
    };
...
UNICODE_MORPH_MODS
    ...
    UNICODE(emoji_cloudy_macro, /* ️☁️ */
      ...
      #elif UNICODE_TARGET_OS == 'W'
        UNICODE_SEQ_WINDOWS(&kp N0 &kp F &kp E &kp N0 &kp F), <&macro_wait_time UNICODE_SEQ_DELAY>, UNICODE_SEQ_WINDOWS(&kp N0 &kp N2 &kp N<&world_currency_yen>, <&world_currency_RALT>;
        mods = <(MO6 &kp N0 &kp N1), UNICODE_SEQ_WINDOWS(&kp N0 &kp F &kp E &kp N0 &kp F)
      #endif
    )
